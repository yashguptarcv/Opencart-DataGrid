...
class Column
{
    ...
    public function init(array $column): void
    {
        ...
        $this->setAttachment($column['attachment'] ?? $this->attachment);

        $this->setImage($column['image'] ?? $this->image);
    }
    ...
    /**
     * Define the table's column width. Initially, it will match the index. However, after adding an alias,
     * the column width may change.
     */
